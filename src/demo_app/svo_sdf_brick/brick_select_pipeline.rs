...
use super::{BrickInstances, GPUGeometryTransforms};
...
impl SvoBrickSelectPipeline {
    ...
    pub fn new(context: &RenderContext) -> Self {
        ...
        let geometry_instances_transforms_bind_group_layout =
            GPUGeometryTransforms::create_bind_group_layout(
                &context.gpu,
                wgpu::ShaderStages::COMPUTE,
            );
        ...
        let pipeline = {
            ...
            context
                ...
                .create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
                    ...
                    module: &context.gpu.device.create_shader_module(
    ...
    pub fn run(
        ...
        // Prepare bind groups
        let node_bind_group = svo
            .node_pool
            .create_bind_group(&context.gpu, &self.node_pool_bind_group_layout);
        let brick_instances_bind_group = brick_instances
            .create_bind_group(&context.gpu, &self.brick_instances_bind_group_layout);
        let geometry_instances_transforms_bind_group = transforms.create_bind_group(
            &context.gpu,
            &self.geometry_instances_transforms_bind_group_layout,
        );
