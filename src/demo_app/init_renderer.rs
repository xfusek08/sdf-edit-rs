...
use super::{
    cube::CubeOutlineRenderModule, line::LineRenderModule, scene::Scene,
    svo_sdf_brick::SvoSdfBricksRenderModule, svo_wireframe::SvoWireframeRenderModule,
};
...
pub fn init_renderer(context: &Context) -> Renderer<Scene> {
    ...
    renderer.register_render_pass(RenderPass::gui, &[gui_module]);
